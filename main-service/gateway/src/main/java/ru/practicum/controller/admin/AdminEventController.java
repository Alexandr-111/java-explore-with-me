...
public class AdminEventController {
    ...
    public ResponseEntity<EventFullDto> finishEvent(@Positive @PathVariable Long eventId) {
        log.debug("AdminEventController.Администратор отмечает как завершившееся, событие с id {}", eventId);
        return client.finishEvent(eventId);
    }
}